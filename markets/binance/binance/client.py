...
class Client(object):
    ...
    def _create_api_uri(self, path, signed=True, version=PUBLIC_API_VERSION):
        ...
        :param path: 
        :param signed:  (Default value = True)
        :param version:  (Default value = PUBLIC_API_VERSION)
    ...
    def _request(self, method, uri, signed, force_params=False, **kwargs):
        ...
        :param uri: 
        :param signed: 
        :param force_params:  (Default value = False)
        :param **kwargs: 
    ...
    def _request_api(self, method, path, signed=False, version=PUBLIC_API_VERSION, **kwargs):
        ...
        :param method: 
        :param path: 
        :param signed:  (Default value = False)
        :param version:  (Default value = PUBLIC_API_VERSION)
        :param **kwargs: 
    ...
    def aggregate_trade_iter(self, symbol, start_str=None, last_id=None):
        ...
        return the first trade occurring later than this time. (Default value = None)
        :type start_str: str: str|int
        :param last_id: aggregate trade ID of the last known aggregate trade.
        Not a regular trade ID. See https://github.com/binance-exchange/binance-official-api-docs/blob/master/rest-api.md#compressedaggregate-trades-list. (Default value = None)
    ...
    def get_klines(self, **params):
        ...
        :param symbol: required
        :type symbol: str
        :param interval: type interval: str
        :param limit: Default 500; max 500.
        :type limit: int
        :param startTime: type startTime: int
        :param endTime: type endTime: int
        :param **params: 
        :returns: API response
